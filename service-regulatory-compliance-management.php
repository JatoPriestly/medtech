            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-md-6 text-center" data-aos="fade-up" data-aos-duration="1000">
                    <div style="max-width: 500px; margin: auto;">
                        <h1 class="text-uppercase fw-bold">Regulatory Compliance Management</h1>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-white help-section primary">
    <div class="container py-5 text-md-center">
        <div class="mx-auto">
            <div class="row">
                <h2 class="fw-bold">Expert Regulatory Compliance Management for Medical Devices<br></h2>
                <div class="box col-md-8 col-xl-6 text-center mx-auto">
                    <p>At MedTech Assist Ltd., we provide expert regulatory compliance management services to help medical device manufacturers navigate complex regulatory frameworks. Our team ensures alignment with international standards, including FDA, EU MDR, and ISO regulations, facilitating a smooth pathway to market approval. We specialize in developing tailored regulatory strategies, preparing comprehensive technical documentation, and managing communication with regulatory authorities to expedite approvals. With our guidance, businesses can confidently meet compliance requirements, gain market access, and maintain ongoing regulatory adherence, ensuring the safe and effective introduction of medical devices worldwide.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            ...
                            <h4 class="secondary fw-bold mb-0">Comprehensive Regulatory Strategy Development</h4>
                        </div>
                        <p>Creating a clear compliance roadmap for global market success.</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2 "><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                    ...
                                    </svg></span><span class="text-sm">Tailored Compliance Roadmaps.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Risk-Based Compliance Planning.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Multi-Market Adaptation.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <span class="fa fa-pencil-alt me-2"></span>
                            <h4 class="secondary fw-bold mb-0">Technical Documentation & Market Access Support</h4>
                        </div>
                        <p>Ensuring seamless regulatory submissions and approvals.</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Product Technical File Preparation.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Regulatory Submission Assistance.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Labeling & Packaging Compliance.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <span class="fa fa-pencil-alt me-2"></span>
                            <h4 class="secondary fw-bold mb-0">Regulatory Liaison & Approval Facilitation</h4>
                        </div>
                        <p>Facilitating direct engagement with regulatory authorities for faster approvals.</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Direct Communication with Authorities.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Audit & Inspection Readiness.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Post-Market Compliance Support.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
