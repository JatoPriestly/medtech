            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-md-6 text-center" data-aos="fade-up" data-aos-duration="1000">
                    <div style="max-width: 500px; margin: auto;">
                        <h1 class="text-uppercase fw-bold">Consulting</h1>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-white help-section primary">
    <div class="container py-5 text-md-center">
        <div class="mx-auto">
            <div class="row">
                <h2 class="fw-bold">CONSULTING SERVICES FOR MEDICAL TECHNOLOGY COMPANIES<br></h2>
                <div class="box col-md-8 col-xl-6 text-center mx-auto">
                    <p>MedTech Assist Ltd. offers expert consulting to guide medical technology firms through regulatory complexities and operational efficiency. Our experienced team provides tailored solutions for market entry, product development, and regulatory strategy, empowering clients to navigate the evolving medical device landscape.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            ...
                            <h4 class="secondary fw-bold mb-0">Consulting Services</h4>
                        </div>
                        <p>Expert guidance for medical technology firms</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2 "><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                    ...
                                    </svg></span><span class="text-sm">Market entry strategy development.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Regulatory strategy alignment.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Operational efficiency improvement.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <span class="fa fa-pencil-alt me-2"></span>
                            <h4 class="secondary fw-bold mb-0">Regulatory Compliance Management</h4>
                        </div>
                        ...
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Compliance audits and assessments.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Regulatory training programs.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Documentation and reporting support.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <span class="fa fa-pencil-alt me-2"></span>
                            <h4 class="secondary fw-bold mb-0">Quality Management Systems</h4>
                        </div>
                        ...
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Implementation of ISO standards.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Continuous improvement processes.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Training and support for quality assurance.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
