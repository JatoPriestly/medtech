...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['img_url']) && $_FILES['img_url']['error'] == UPLOAD_ERR_OK) {
        ...
        $img_new_name = "blogs/blog_$blog_id.$img_extension";
        $img_url = "admin/".$img_new_name;
        move_uploaded_file($img_tmp_name, $img_new_name);
        // Insert into database to get the new blog ID
        $stmt = $pdo->prepare("INSERT INTO blog (title, slug, description, subtitle1, text1, subtitle2, text2, reference, img_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)");
        $stmt->execute([$title, $slug, $description, $subtitle1, $text1, $subtitle2, $text2, $reference,$img_url]);
        ...
        $stmt = $pdo->prepare("UPDATE blog SET img_url = ? WHERE id = ?");
        $stmt->execute([$img_new_name, $blog_id]);
            ...
            <div id="content">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <div style="margin-left:4px; margin-right:4px;" class="card w-100 shadow border-start-primary py-2">
                        <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Add Blog</h3>
                    </div>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="subtitle1">
                            </div>
                            <div class="mb-3">
