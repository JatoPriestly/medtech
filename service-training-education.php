            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-md-6 text-center" data-aos="fade-up" data-aos-duration="1000">
                    <div style="max-width: 500px; margin: auto;">
                        <h1 class="text-uppercase fw-bold">Training & Education</h1>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-white help-section primary">
    <div class="container py-5 text-md-center">
        <div class="mx-auto">
            <div class="row">
                <h2 class="fw-bold">Specialized Training & Education for Regulatory Compliance and Quality Management<br></h2>
                <div class="box col-md-8 col-xl-6 text-center mx-auto">
                    <p>At MedTech Assist Ltd., we provide specialized training and education programs designed to equip professionals with the knowledge and skills necessary to meet industry standards and regulatory requirements. Our expert-led sessions cover key areas such as regulatory affairs, quality management systems, risk management, and ISO standards, ensuring your team stays informed and compliant in an evolving regulatory landscape. We offer customized training solutions tailored to the unique needs of your organization, enhancing compliance, reducing risks, and improving overall operational efficiency. Through our comprehensive training programs, we empower businesses to foster a culture of quality and continuous improvement.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            ...
                            <h4 class="secondary fw-bold mb-0">Comprehensive Industry-Specific Training Programs</h4>
                        </div>
                        <p>Equipping professionals with essential regulatory and quality expertise</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2 "><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                    ...
                                    </svg></span><span class="text-sm">Regulatory Affairs & Compliance Training.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Quality Management System (QMS) Training.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Risk Management & Mitigation Strategies.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <span class="fa fa-pencil-alt me-2"></span>
                            <h4 class="secondary fw-bold mb-0">Customized Learning Solutions for Business Needs</h4>
                        </div>
                        <p>Providing tailored training to address specific organizational challenges.</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Tailored Training Programs.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>On-Demand & In-Person Training.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Practical Case Studies & Hands-On Exercises.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card bg-white border-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <span class="fa fa-pencil-alt me-2"></span>
                            <h4 class="secondary fw-bold mb-0">Enhancing Compliance and Workforce Expertise</h4>
                        </div>
                        <p>Empowering teams to maintain compliance and drive business success.</p>
                        <div>
                            <ul class="list-unstyled">
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Improving Regulatory Readiness.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Reducing Compliance Risks.</span></li>
                                <li class="d-flex mb-2"><span class="bs-icon-xs bs-icon-rounded  bs-icon bs-icon-xs me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-check-lg secondary">
                                        <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"></path>
                                    </svg></span><span>Fostering Continuous Professional Development.</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
