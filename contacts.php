        ...
        <div class="container h-100">
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-md-6 text-center" data-aos="fade-up" data-aos-duration="1000">
                    <div>
                        <h1 class="text-uppercase fw-bold">GET IN TOUCH</h1>
...
<!-- <section class="bg-white help-section primary" data-aos="fade-up">
    <div class="container py-5 text-md-center">
        <div class="mx-auto">
            <div class="row">
                <h2 class="fw-bold secondary">Empowering the Future of Healthcare with Expert Solutions<br></h2>
                <div class="box col-md-8 col-xl-6 text-center mx-auto">
                    <p>From Regulatory Compliance to Innovation, we help life sciences and healthcare organizations grow while ensuring the highest standards of quality and safety.</p>
                </div>
            </div>
        </div>
    </div>
